#!/bin/bash
# Add Samsung Galaxy Fit 3 via API
# Usage: Update API_URL and ADMIN_TOKEN, then run this script

API_URL="${API_URL:-https://your-render-url.onrender.com/api}"
# ADMIN_TOKEN="your-admin-token-here"  # Get from admin login
